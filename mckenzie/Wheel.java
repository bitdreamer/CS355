...
public class Wheel
{
	...
	public Wheel(double aX, double aZ, float[] cColor)
	{
		anX=aX;
		anZ=aZ;
		color=cColor;
		...
		corner[1] = new Point( aX, 0, 0.1+aZ );
		corner[2] = new Point( aX, 0.1, 0+aZ );
		corner[3] = new Point( aX, 0.1, 0.1+aZ );
		corner[4] = new Point( aX+0.1, 0, 0+aZ );
		corner[5] = new Point( aX+0.1, 0, 0.1+aZ );
		corner[6] = new Point( aX+0.1, 0.1, 0+aZ );
		corner[7] = new Point( aX+0.1, 0.1, 0.1+aZ );
	}
