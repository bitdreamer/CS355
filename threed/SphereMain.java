// SphereMain.java
// Barrett Koster 2014
// This supports drawing of the sphere
...
public class SphereMain  extends JFrame implements GLEventListener // ActionListener,
   // , MouseListener
{
   private GLU glu = new GLU(); // just has some function we like
   Animator goThingy;
   final SphereMain thisthis; // for use in contexts where "this" doesn't work
   double yrot = 0;
   ...
   public void display(GLAutoDrawable gLDrawable) 
   {
     // update();
       ...
       // gl.glTranslatef(-1.5f, 0.0f, -6.0f);
        ...
        sphere1.drawMe(gl); // big center cube
        gl.glPopMatrix();
       // gl.glSc
