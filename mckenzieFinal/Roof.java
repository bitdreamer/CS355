...
public class Roof 
{
	...
	public Roof(double aX, double aZ, float[] rColor)
	{
		...
		corner[0] = new Point1( aX, 1, 0+aZ );
		corner[1] = new Point1( aX, 1, 1+aZ );
		//corner[2] = new Point1( aX, 0.5+1, 0.5+aZ );
		corner[2] = new Point1(aX+0.5, 0.5+1, 0.5+aZ);
		corner[4] = new Point1( aX+1, 1, 0+aZ );
		corner[5] = new Point1( aX+1, 1, 1+aZ );
		//corner[6] = new Point1( aX+1, 0.5+1, 0.5+aZ );
	}
